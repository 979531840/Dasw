...
<div>
    ...
    <div class="public-content">
        <div class="public-content-header">
            <h3 style="font-size:15px;font-weight:bold;">新增业务员</h3>
        </div>
        <div class="public-content-cont">
            <form data-toggle="validator" class="form-horizontal" id="defaultForm" name="defaultForm" action="${ctx}/user/add" method="post">
                <div class="form-group ">
                    <label for="userName" class=" control-label " >员工姓名：</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="userName" name="userName"  placeholder="员工姓名" value="">
                    </div>
                </div>
               <!--  <div class="form-group ">
                    <label for="userType" class=" control-label">员工类型：</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="userType" name="userType" placeholder="员工类型"  value="">
                    </div>
                </div> -->
                 <div class="form-group ">
                    <label for="userType" class=" control-label">员工类型：</label>
                ...
                <div class="form-group ">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="userAge" name="userAge" placeholder="年龄"  value="">
                    </div>
                </div>
                <div class="form-group ">
                ...
                <div class="form-group ">
                    ...
                    <div class="col-sm-3">
                        <input type="email" class="form-control" id="userEmail" name="userEmail" placeholder="邮箱"  value="">
                    </div>
                </div>
                <div class="form-group ">
                    <label for="userUsername" class=" control-label">用户名：</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="userUsername" name="userUsername" placeholder="用户名"  value="">
                    </div>
                </div>
                <div class="form-group ">
                    <label for="userPassword" class=" control-label">用户密码：</label>
                    <div class="col-sm-3">
                        <input type="password" class="form-control" id="userPassword" name="userPassword" placeholder="用户密码"  value="">
                    </div>
                </div>
                ...
                <div class="form-group ">
                    ...
                    <div class="col-sm-3">
                        <input type="number" class="form-control" id="userTel" name="userTel" placeholder="联系方式"  value="">
                    </div>
                </div>
                <div class="form-group ">
                    <label for="userAddress" class=" control-label">联系地址：</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="userAddress" name="userAddress" placeholder="联系地址"  value="">
                    </div>
                </div>
                <div class="form-group form-inline">
                    <div class="col-md-10 col-md-offset-1">
                        <input type="submit" class="button button-glow button-rounded button-raised button-primary" value="保存"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="reset" class="button button-glow button-border button-rounded button-primary" value="取消"/>
                    </div>
                </div>
            </form>
