...
<div>
    ...
    <div class="public-content">
        ...
        <div class="public-content-cont">
            <form data-toggle="validator" class="form-horizontal" id="defaultForm" name="defaultForm" action="${ctx}/purchase/purchaseEdit" method="post">
                <h3 style="font-size:15px;font-weight:bold;">采购信息</h3><br>
                <input type="hidden" id="purchaseId" name="purchaseId" value="${purchaseDetail.purchaseId}">
