...
<div>
    ...
    <div class="public-content">
        <div class="public-content-header">
            <h3 style="font-size:15px;font-weight:bold;">添加发货信息</h3>
        </div>
        <div class="public-content-cont">
            <form data-toggle="validator" class="form-horizontal" id="defaultForm" name="defaultForm" action="${ctx}/send/sendAdd" method="post">
                <h3 style="font-size:15px;font-weight:bold;">发货信息</h3><br>
                <input type="hidden" id="orderId" name="orderId" id="orderId" value="${orderId}">
                <div class="form-group ">
                    <label for="" class=" control-label " >订单ID：</label>
                    <div class="col-sm-3">
                        <label for="" class=" control-label " >${orderId}</label>
                    </div>
                </div>
                <div class="form-group ">
                ...
                <div class="form-group ">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="sendWay" name="sendWay" required>
                    </div>
                </div>
                <div class="form-group ">
                    <label for="sendCourierid" class=" control-label">单号：</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="sendCourierid" name="sendCourierid">
                    </div>
                </div>
