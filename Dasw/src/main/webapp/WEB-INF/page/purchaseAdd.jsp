...
<div>
    ...
    <div class="public-content">
        <div class="public-content-header">
            <h3 style="font-size:15px;font-weight:bold;">添加采购记录</h3>
        </div>
        <div class="public-content-cont">
            <form data-toggle="validator" class="form-horizontal" id="defaultForm" name="defaultForm" action="${ctx}/purchase/purchaseAdd" method="post">
                ...
                <input type="hidden" id="stockProductId" name="stockProductId" value="${produceId}">
                <div class="form-group ">
                    <label for="" class=" control-label " >产品：</label>
                    <div class="col-sm-3">
                        <label for="" class=" control-label " >${produceId}</label>
                    </div>
                </div>
                <div class="form-group ">
                ...
                <div class="form-group ">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="supplierNumber" name="supplierNumber" value="">
                    </div>
                ...
                <div class="form-group ">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="supplierPrice" name="supplierPrice" value="">
                    </div>
                </div>
                <div class="form-group ">
                    <label for="purchaseDate" class=" control-label">日期：</label>
                    <div class="col-sm-3">
                        <input type="date" class="form-control" id="purchaseDate" name="purchaseDate" value="">
                    </div>
                </div>
                <div class="form-group ">
                    <label for="supplierBatch" class=" control-label">批次：</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="supplierBatch" name="supplierBatch" value="">
                    </div>
                </div>
                <div class="form-group ">
                    <label for="supplierMoney" class=" control-label">金额：</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="supplierMoney" name="supplierMoney" value="">
                    </div>
                </div>
                <div class="form-group ">
                    <label for="supplierRate" class=" control-label">税率：</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="supplierRate" name="supplierRate" value="">
                    </div>
                </div>
                <div class="form-group ">
                    <label for="supplierRatemoney" class=" control-label">税款：</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="supplierRatemoney" name="supplierRatemoney" value="">
                    </div>
                </div>
